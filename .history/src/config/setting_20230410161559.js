    ...
    children: [
        {
            ...
            meta: {title: '店员管理', icon: 'team-outlined', hide: false}
        },
    ]
},
  {
      ...
      children: [
          {
            ...
            meta: {title: '基础管理', icon: 'Table-outlined', hide: false},
            children:[
              {
                path:'/equipment/basic/nameplate',
                component:'/equipment/basic/nameplate/index.vue',
                meta: {title: '铭牌管理', icon: 'Table-outlined',hide: false},
              }
            ]
          }, 
          {
          ...
          meta: {title: '设备台账', icon: 'account-book-outlined', hide: false}
          }
      ]
  },
    {
