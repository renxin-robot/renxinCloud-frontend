<template>
    <div class="ele-body">
        ...
        <a-card style="margin-top: 10px;border-radius: 4px;">
            <ele-pro-table ref="tableRef" row-key="userId" title="渠道列表" :resizable="true" :bordered="bordered"
                :striped="striped" :tools-theme="toolDefault ? 'default' : 'none'" :height="tableHeight"
                :full-height="false ? 'calc(100vh - 168px)' : void 0" :columns="columns" :datasource="datasource"
