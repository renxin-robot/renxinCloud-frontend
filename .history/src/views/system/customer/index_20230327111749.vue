<template>
    <div class="ele-body">
            ...
            <div style="display: flex;justify-content: space-between;">
                <el-form :inline="true" :model="formState" class="demo-form-inline">
                    <el-form-item label="客户名称">
                        <a-input v-model="formState.name" placeholder="请输入客户名称" />
                    </el-form-item>
        ...
        <a-card style="margin-top: 10px;border-radius: 4px;">
            <ele-pro-table ref="tableRef" row-key="userId" title="客户列表" :resizable="true" :bordered="true" :columnsFixed="true"
                :height="tableHeight" :full-height="fixedHeight ? 'calc(100vh - 168px)' : void 0" :columns="columns"
                :datasource="userList"  :scroll="{ x: 1000 }" cache-key="proListBasicTable"
                @done="onDone">
                <!-- 表头工具按钮 -->
                <template #toolkit>
...
import { getUser ,addUser,editUser,deleteUser} from '@/api/system/customer';
