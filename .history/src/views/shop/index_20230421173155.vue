<template>
    <div class="ele-body">
        ...
        <a-card style="margin-top: 10px; border-radius: 4px">
            <div id="proTable">
                <ele-pro-table ref="tableRef" title="门店列表" :resizable="true" :bordered="true" :columnsFixed="true"
                    ...
                    <!-- 表头工具按钮 -->
                    <template #toolkit>
                        <a-button type="primary" @click="toAddShopStore"><PlusOutlined />新增门店</a-button>
                    </template>
                    <!-- 自定义列 -->
        ...
        <a-modal v-model:visible="showAssistantVisible" title="店员列表" @ok="handleOk" @cancel="cancelShowModal" width="850px" :footer="null">
            <div>
