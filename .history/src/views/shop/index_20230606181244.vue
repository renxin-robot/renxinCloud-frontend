<template>
    <div class="ele-body">
            ...
            <div style="display: flex; justify-content: space-between">
                <el-form :inline="true" :model="formState" class="demo-form-inline">
                    <el-form-item label="客户名称">
                        <a-input v-model:value="formState.user_name" placeholder="请输入客户名称" />
                    </el-form-item>
        ...
        <a-modal v-model:visible="addVisible" :title="`${ editId ? '编辑' : '新增' }门店`" @ok="handleOk" @cancel="cancelAddShop">
        ...
        <a-modal v-model:visible="showAssistantVisible" :closable="true" @ok="handleOk" @cancel="cancelShowModal" width="850px" :footer="null">
            <div>
                <div style="display: flex;align-items: start;justify-content: space-between;margin-top: 10px;">
                ...
                <div style="height: 260px;overflow-y: scroll;" v-if="assistantList.length">
                    <div v-for="item, index in assistantList" :key="item.id"
                        style="margin-bottom: 10px;display: flex; align-items: center;justify-content: space-between;line-height: 30px;">
                        <div style="display: flex; align-items: center;">
                            ...
                            <div style="display: flex; align-items: center; margin-right: 20px">
                                ...
                                <div style="width: 160px;" v-if="editAssistantIndex!== index">
                                    {{ item.name }}
                                </div>
    ...
    setup() {
        ...
        const handleOk = () => {
            ...
            if (!editId.value) {
                ...
                updateUserStore(shopStoreData).then((res) => {
                    if (res.code == 1) {
                        notification.success({
                            message: '更新成功'
                        });
