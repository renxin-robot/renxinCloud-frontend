...
import {getUserStore,getUserEmployee,addUserEmloyee,updateUserEmloyee,deleteUserEmloyee} from '@/api/shop'
import {getUser} from '@/api/system/customer'
import {notification } from 'ant-design-vue/es';
import { ContactsOutlined, FormOutlined, DeleteOutlined ,UserOutlined} from '@ant-design/icons-vue'
...
export default defineComponent({
    name: 'Order',
    components: { ContactsOutlined, FormOutlined, DeleteOutlined ,UserOutlined},
    setup() {
        ...
        const handleOk=()=>{
            ...
            if(!editId.value){
                addUserEmloyee(shopStoreData).then((res)=>{
                    if(res.code==0){
                        notification.success({
                            message: '新增成功',
                        });
