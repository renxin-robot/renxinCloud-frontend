            ...
            <div>
                <div v-for="item,index in assistantList" :key="item.id"
                    ...
                    <div style="width: 150px;">
                        <a-button type="link" @click="editAssistant(item,index)"  v-if="editAssistantIndex!==index">编辑</a-button>
                        <div v-else>
                            <a-button type="link" @click="cancleEditAssistant(index)">确定</a-button>
                            <a-button type="link" @click="cancleEditAssistant(index)">取消</a-button>
                        </div>
