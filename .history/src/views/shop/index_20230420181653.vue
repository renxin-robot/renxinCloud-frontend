        ...
        <a-card style="border-radius: 4px;height: 74px;">
            <div style="display: flex;justify-content: space-between;">
                ...
                <el-form>
                    <RegionSelects
                        v-model="region"
                        @change="regionChange" :on-update:model-value="region"
                    />
                </el-form>
                <v-region :town="true"></v-region>
                <!-- <RegionSelects v-model="areaList" @change="handleChange" /> -->
...
import {getUserStore,addUserStore,getUserEmployee,addUserEmloyee,updateUserEmloyee,deleteUserEmloyee} from '@/api/shop'
...
export default defineComponent({
    name: 'Order',
    components: { RegionSelects,ContactsOutlined, FormOutlined, DeleteOutlined ,UserOutlined,MinusCircleOutlined,PlusOutlined},
    setup() {
