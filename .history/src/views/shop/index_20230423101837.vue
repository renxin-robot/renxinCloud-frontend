                ...
                <div style="height: 300px;overflow-y: scroll;" v-if="assistantList.length">
                    <div v-for="item, index in assistantList" :key="item.id"
                        ...
                        <div style="display: flex; align-items: center;">
                            <div style="display: flex; align-items: center; margin-right: 20px">
                                <div style="margin-right: 10px"><IdcardOutlined style="margin-right: 5px"/>角色：</div>
                            ...
                            <div style="display: flex; align-items: center; margin-right: 20px">
                                <div style="margin-right: 10px"><UserOutlined style="margin-right: 5px"/>账号：</div>
                            ...
                            <div style="display: flex; align-items: center; margin-right: 20px" v-if="editAssistantIndex===index">
                                <div style="margin-right: 10px"><LockOutlined style="margin-right: 5px"/>密码:</div>
