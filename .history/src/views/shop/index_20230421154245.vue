<template>
    <div class="ele-body">
        ...
        <a-modal v-model:visible="showAssistantVisible" title="店员列表" @ok="handleOk" @cancel="cancelShowModal" width="800px" :footer="null">
            <div>
                <div style="margin-bottom: 10px;">
                    <a-button type="primary" @click="addAssistant">新增店员</a-button>
                </div>
                <div style="display: flex; align-items: center;margin:20px 0px;" v-if="showAddInput">
                    ...
                    <div style="display: flex; align-items: center; margin-right: 20px">
                        ...
                        <div>
                            <a-input v-model:value="newAssistantData.account" placeholder="请输入账号..." />
                        </div>
                    </div>
                    <div style="display: flex; align-items: center; margin-right: 20px">
                ...
                <div style="height: 300px;overflow: scroll;" v-if="assistantList.length">
                    <div v-for="item, index in assistantList" :key="item.id"
                        ...
                        <div style="display: flex;">
                            ...
                            <div v-else style="display: flex;">
                                <a-button type="link" @click="confirmEditAssistant(item)">确定</a-button>
                                <a-button type="link" @click="cancleEditAssistant"><span
                                        style="color:gray;">取消</span></a-button>
                            </div>
                            <div>
