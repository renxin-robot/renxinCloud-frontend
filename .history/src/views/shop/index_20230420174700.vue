...
export default defineComponent({
    ...
    setup() {
        ...
        let areaList=['440000','440300','440308']
        ...
        const editChannel=(row)=>{
            ...
            // areaList.value=(row.province_code+','+row.city_code+','+row.area_code).split(',')
            // areaList.value=['440000','440300','440308']
            console.log(areaList,'kkk')
            addVisible.value=true
        }
