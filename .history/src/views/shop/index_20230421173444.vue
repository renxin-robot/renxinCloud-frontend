<template>
    <div class="ele-body">
        ...
        <a-modal v-model:visible="showAssistantVisible"  @ok="handleOk" @cancel="cancelShowModal" width="850px" :footer="null">
            <div>
                <div style="display: flex;align-items: center;justify-content: space-between;margin-top: 20px;">
                    <div style="font-size: 15px;font-weight: bold;">店员列表</div>
