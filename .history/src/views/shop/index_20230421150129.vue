<template>
    <div class="ele-body">
        ...
        <a-modal v-model:visible="showAssistantVisible" title="店员列表" @ok="handleOk" width="700px" :footer="null">
            <div>
                <div v-for="item,index in assistantList" :key="item.id"
                    ...
                    <div style="display: flex;">
                        ...
                        <div v-else style="display: flex;">
                            <a-button type="link" @click="confirmEditAssistant(item)">确定</a-button>
        ...
        const confirmEditAssistant=(row)=>{
            ...
            updateUserEmloyee(editAssistantInfo).then((res)=>{
                if (res.code == 1) {
                    ...
                    getUserEmployee(row.store_id).then((res) => {
                        if (res.code == 0) {
                            assistantList.value = res.data;
                        }
                    });
