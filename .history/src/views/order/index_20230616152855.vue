    ...
    <div class="ele-body">
        ...
        <a-modal v-model:visible="addVisible" title="新增订单" @ok="handleOk" @cancel="closeModal">
            <a-form :model="orderData" name="basic" :label-col="{ span: 5 }" :wrapper-col="{ span: 16 }" autocomplete="off">
                <a-form-item label="订单类型" name="device_journal_id"
                    :rules="[{ required: true, message: '请选择订单类型！' }]">
                    <a-select
                    ref="select"
                    v-model:value="orderData.orderType">
                ...
                <a-form-item label="支付方式" name="device_journal_id"  v-if="orderData.orderType=='offline'"
                ...
                <a-form-item label="支付账号"  v-if="orderData.orderType=='offline'"
                    :rules="[{ required: true, message: '请输入支付账号！' }]"> 
                    <a-input v-model:value="orderPrice" placeholder="请输入支付账号" :disabled="false"/>
                </a-form-item>
                <a-form-item label="支付流水号"  v-if="orderData.orderType=='offline'"
                    :rules="[{ required: true, message: '请输入支付流水号！' }]">
                    <a-input v-model:value="orderPrice" placeholder="请输入支付流水号" :disabled="false"/>
                </a-form-item>
                <a-form-item label="支付时间"  v-if="orderData.orderType=='offline'"
                    :rules="[{ required: true, message: '请输入支付时间！' }]">
                    <a-input v-model:value="orderPrice" placeholder="请输入支付时间" :disabled="false"/>
                </a-form-item>
                ...
                <a-form-item label="试用原因" name="remark"  v-if="orderData.orderType=='trial'">
