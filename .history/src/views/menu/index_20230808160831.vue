    ...
    <div class="ele-body">
        ...
        <a-card style="margin-top: 10px;border-radius: 4px;">
            <ele-pro-table ref="tableRef" :selection="selectMenu" title="菜谱管理列表"  :resizable="true" :bordered="true" :columnsFixed="true"
                ...
                <!-- 表头工具按钮 -->
                <template #toolkit>
                    <a-button type="info" @click="toChooseMenu"><DownloadOutlined />取消下发</a-button>
                    <a-button type="primary" @click="toChooseMenu"><DownloadOutlined />菜谱下发</a-button>
                    <a-button type="primary" @click="toChooseMenu" v-if="selectMenu?.length"><DownloadOutlined />选好菜谱，去下发</a-button>
                </template>
                <!-- 自定义列 -->
