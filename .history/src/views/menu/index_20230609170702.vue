<template>
    <div class="ele-body">
        ...
        <a-card style="margin-top: 10px;border-radius: 4px;">
            <ele-pro-table ref="tableRef" title="菜谱列表" :resizable="true" :bordered="true" :columnsFixed="true"
                :columns="columns" :datasource="datasource"
                :scroll="{ x: 1000 }">
                <!-- 表头工具按钮 -->
                <template #toolkit>
                    <a-button type="primary">新增菜谱</a-button>
                </template>
                <!-- 自定义列 -->
                    ...
                    <template v-else-if="column.key === 'action'">
                        <a-space>
                            ...
                            <a-tooltip placement="bottom">
                                ...
                                <a @click="toSeeFolder(record)"><FolderOpenOutlined /></a>
                            </a-tooltip>
                        </a-space>
                    </template>
                </template>
...
import {InfoCircleOutlined,FolderOpenOutlined} from '@ant-design/icons-vue'
import { useRouter } from 'vue-router';
export default defineComponent({
    components:{InfoCircleOutlined,FolderOpenOutlined},
    setup(){
