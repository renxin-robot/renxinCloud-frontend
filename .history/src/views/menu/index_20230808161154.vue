        ...
        <a-card style="margin-top: 10px;border-radius: 4px;">
            <ele-pro-table ref="tableRef" :selection="selectMenu" title="菜谱管理列表"  :resizable="true" :bordered="true" :columnsFixed="true"
                ...
                <template #toolkit>
                    ...
                    <a-button type="primary" @click="toChooseMenu" v-else><DownloadOutlined />菜谱下发</a-button>
                    <a-button type="primary" @click="toChooseMenu" :disabled="selectMenu?.length">选好菜谱，去下发</a-button>
                </template>
                <!-- 自定义列 -->
