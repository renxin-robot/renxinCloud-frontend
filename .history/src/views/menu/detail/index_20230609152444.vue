    ...
    <div class="ele-body container">
        ...
        <a-card style="border-radius: 4px;margin-top:10px;" title="备菜流程" class="flowContainer">
            <div class="flowContent">
                ...
                <div v-for="item in total" :key="item.id" style="margin-left: 10px;">
                    <p>{{ item.name }}</p>
                    ...
                    <p>
                        <a-textarea v-model:value="des1" style="border-radius: 4px;width: 90%;" placeholder="Basic usage" :rows="4" />
                    </p>
                    <p>
                        <a-divider />
                    </p>
