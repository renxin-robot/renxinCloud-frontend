<template>
    <div class="ele-body container">
        ...
        <a-card style="border-radius: 4px;margin-top:10px;" title="菜谱工艺" class="flowContainer">
            <ele-pro-table ref="tableRef" :resizable="true" :bordered="false" :columnsFixed="true" :needPage="false"
