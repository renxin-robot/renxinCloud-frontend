    ...
    <div class="ele-body">
        ...
        <a-modal v-model:visible="addVisible" :title="`${ editId ? '编辑' : '新增' }产品信息`" @ok="handleOk">
            <a-form :model="plantInfo" name="basic" :label-col="{ span: 6 }" :wrapper-col="{ span: 16 }"
                ...
                <a-form-item label="产品型号" name="category" :rules="[{ required: true, message: '请输入生产商编号！' }]">
                ...
                <a-form-item label="产品类型" name="type" :rules="[{ required: true, message: '请输入生产商电话！' }]">
                ...
                <a-form-item label="产品版本" name="version" :rules="[{ required: true, message: '请输入生产商编号！' }]">
                    <a-input v-model:value="plantInfo.version" />
                </a-form-item>
                <a-form-item label="版本编号" name="version_code" :rules="[{ required: true, message: '请输入生产商地址！' }]">
                    <a-input v-model:value="plantInfo.version_code" />
                </a-form-item>
                <a-form-item label="产品执行标准" name="standard" :rules="[{ required: true, message: '请输入生产商电话！' }]">
                ...
                <a-form-item label="额定电流" name="electric_current" :rules="[{ required: true, message: '请输入生产商编号！' }]">
                    <a-input v-model:value="plantInfo.electric_current" />
                </a-form-item>
                <a-form-item label="额定频率" name="rate" :rules="[{ required: true, message: '请输入生产商地址！' }]">
                    <a-input v-model:value="plantInfo.rate" />
                </a-form-item>
                <a-form-item label="额定功率" name="power" :rules="[{ required: true, message: '请输入生产商电话！' }]">
