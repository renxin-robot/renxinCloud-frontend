            ...
            <div style="display: flex;justify-content: space-between;">
                <el-form :inline="true" :model="formState" class="demo-form-inline">
                    <el-form-item label="品类名称">
                        <a-input v-model:value="formState.name" placeholder="请输入品类名称" @pressEnter="toSearch" />
                    </el-form-item>
                </el-form>
                <div>
        ...
        <a-modal v-model:visible="addVisible" :title="`${ editId ? '编辑' : '新增' }品类`" @ok="handleOk">
            <a-form :model="namePlateInfo" name="basic" :label-col="{ span: 6 }" :wrapper-col="{ span: 16 }"
                ...
                <a-form-item label="品类名称" name="name"
                    ...
                    <a-input v-model:value="namePlateInfo.name"  placeholder="请输入..."/>
                </a-form-item>
                <a-form-item label="编号" name="code" :rules="[{ required: true, message: '请输入编号！' }]">
                    <a-input v-model:value="namePlateInfo.code"  placeholder="请输入..."/>
                </a-form-item>
                <a-form-item label="备注" name="screen_code" :rules="[{ required: true, message: '请输入备注！' }]">
