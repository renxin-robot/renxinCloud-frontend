                ...
                <ele-pro-table ref="tableRef" title="铭牌列表" :resizable="true" :bordered="true" :columnsFixed="true"
                    ...
                    <template #bodyCell="{ column, record }">
                        <template v-if="column.dataIndex === 'status'">
                            <div v-if="record.is_used=='1'" style="position: relative;top:-12px;">
                                <span style="font-size: 50px;position: absolute;top:10px;color:green;margin-right: 4px;">.</span>
                                <span>启用</span>
                            </div>
                            <div v-else style="position: relative;top:-12px;">
