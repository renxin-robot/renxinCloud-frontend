                ...
                <ele-pro-table ref="tableRef" title="铭牌列表" :resizable="true" :bordered="true" :columnsFixed="true"
                    ...
                    <template #bodyCell="{ column, record }">
                        <template v-if="column.dataIndex === 'status'">
                            <div v-if="record.is_used=='1'">
                                <span style="font-size: 50px;position: relative;top:-2px;color:green;">.</span>
                                <span>启用</span>
                            </div>
                            <div v-else>
                                <span style="font-size: 50px;position: relative;top:-2px;color:gray;">.</span>
                                <span>未启用</span>
                            </div>
