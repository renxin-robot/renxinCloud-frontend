                    ...
                    <template #bodyCell="{ column, record }">
                        <template v-if="column.dataIndex === 'status'">
                            <div v-if="record.status=='accepted'" style="position: relative;">
                                <span style="color:green;">审批完成</span>
                            </div>
                        ...
                        <template v-if="column.dataIndex === 'type'">
                            <div v-if="record.status=='deployment'" style="position: relative;">
                                <a-tag color="blue">布机</a-tag>
                            </div>
                            <div v-if="record.status=='change'" style="position: relative;">
                                <a-tag color="green">移机</a-tag>
                            </div>
                            <div v-if="record.status=='withdrawal'" style="position: relative;">
