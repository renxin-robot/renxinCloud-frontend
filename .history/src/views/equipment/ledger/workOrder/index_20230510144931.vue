<template>
    <div class="ele-body">
        <a-card style="border-radius: 4px;height: 170px;">
            ...
            <p>
                ...
                <div>
                    <a-radio-group v-model:value="formState.type" button-style="solid">
                        <a-radio-button value="pending" style="border: none;">布机</a-radio-button>
                        <a-radio-button value="accepted" style="border: none;">移机</a-radio-button>
                        <a-radio-button value="rejected" style="border: none;">撤机</a-radio-button>
                    </a-radio-group>
                </div>
            </p>
        </a-card>
                    ...
                    <template #bodyCell="{ column, record }">
                        ...
                        <template v-else-if="column.key === 'action'">
                            <a-space>
                                ...
                                <a-popconfirm title="启用铭牌后不可关闭，是否确认启用?" ok-text="确认" cancel-text="取消"
                                        @confirm="toUseNameplate(record)">
                                        <a v-if="record.is_used=='0'">
