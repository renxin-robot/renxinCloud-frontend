                    ...
                    <template #bodyCell="{ column, record }">
                        ...
                        <template v-else-if="column.key === 'action'">
                            <a-space>
                                ...
                                <a @click="editChannel(record)"><InfoCircleOutlined /></a>
                            </a-tooltip>
...
import { ContactsOutlined, FormOutlined, DeleteOutlined ,InfoCircleOutlined} from '@ant-design/icons-vue'
...
export default defineComponent({
    name: 'Nameplate',
    components: { ContactsOutlined, FormOutlined, DeleteOutlined ,InfoCircleOutlined},
    setup() {
