                    ...
                    <div class="deviceDes">
                        ...
                        <div class="desBottom">
                            <div>
                                ...
                                <span>{{ name??currentRoute.query.name }}</span>
                            </div>
                            <div>
...
export default defineComponent({
    ...
    setup() {
        ...
        let status = JSON.parse(localStorage.getItem('detail'))?.status
        ...
        let name = JSON.parse(localStorage.getItem('detail'))?.device_info?.name??currentRoute.value.query.name
