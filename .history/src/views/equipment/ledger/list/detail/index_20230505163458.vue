            ...
            <a-tabs v-model:activeKey="activeKey">
                ...
                <a-tab-pane key="4" tab="设备详情">
                    <div class="detailInfo">
                        ...
                        <div>
                            <p>
                                <span style="color: gray;display: inline-block;width: 110px;">生产商名称：</span>
                            ...
                            <p>
                                <span style="color: gray;display: inline-block;width: 110px;">生产商地址：</span>
                        ...
                        <div>
                            <p>
                                <span style="color: gray;display: inline-block;width: 110px;">代理商编号：</span>
                        ...
                        <div>
                            <p>
                                <span style="color: gray;display: inline-block;width: 110px;">商户编号：</span>
                                <span>{{detailInfo?.device_info?.name }}</span>
                            </p>
                            <p>
                            ...
                            <p>
                                <span style="color: gray;display: inline-block;width: 110px;">租用开始时间：</span>
                                <span>{{detailInfo?.device_info?.name }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 110px;">租用结束时间：</span>
                                <span>{{detailInfo?.device_info?.name }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 110px;">联系电话：</span>
