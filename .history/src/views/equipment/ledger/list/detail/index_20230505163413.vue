            ...
            <a-tabs v-model:activeKey="activeKey">
                ...
                <a-tab-pane key="4" tab="设备详情">
                    <div class="detailInfo">
                        ...
                        <div>
                            <p>
                                <span style="color: gray;display: inline-block;width: 90px;">生产商名称：</span>
                                <span>{{detailInfo?.device_info?.operator_name }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 90px;">联系电话：</span>
                                <span>{{detailInfo?.device_info?.phone }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 90px;">生产商地址：</span>
                        ...
                        <div>
                            <p>
                                <span style="color: gray;display: inline-block;width: 90px;">代理商编号：</span>
                                <span>{{detailInfo?.channel?.code }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 90px;">代理商名称：</span>
                            ...
                            <p>
                                <span style="color: gray;display: inline-block;width: 90px;">联系地址：</span>
                                <span v-if="detailInfo?.channel">{{detailInfo?.channel?.channel_areas?.province}}{{detailInfo?.channel?.channel_areas?.city}}{{detailInfo?.channel?.channel_areas?.area}}</span>
                            </p>
                            <a-divider style="margin:10px 0px;"/>
                        </div>
                        <div>
                            <p>
                                <span style="color: gray;display: inline-block;width: 90px;">商户编号：</span>
                                <span>{{detailInfo?.device_info?.name }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 90px;">商户名称：</span>
                                <span>{{detailInfo?.device_info?.name }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 90px;">门店名称：</span>
                                <span>{{detailInfo?.device_info?.name }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 90px;">租用开始时间：</span>
                                <span>{{detailInfo?.device_info?.name }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 90px;">租用结束时间：</span>
                                <span>{{detailInfo?.device_info?.name }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 90px;">联系电话：</span>
