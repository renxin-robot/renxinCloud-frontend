    ...
    <div class="ele-body detailBody">
        <a-card class="detailBodyLeft">
            ...
            <p>
                ...
                <span>{{ledgerStore.info.channel.code }}</span>
                <a-divider type="vertical" style="margin: 0px 4px;"/>
                <span>{{ledgerStore.info.channel.name}}</span>
            </p>
            <p>
                <span style="color: gray;">代理商区域：</span>
                <span>{{ledgerStore.info.channel. channel_areas.province}}{{ledgerStore.info.channel. channel_areas.city}}{{ledgerStore.info.channel. channel_areas.area}}</span>
            </p>
            <a-divider  style="margin-bottom: 10px;"/>
            <p>
