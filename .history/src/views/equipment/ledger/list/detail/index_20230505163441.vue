        ...
        <a-card class="detailBodyLeft">
            ...
            <div style="display: flex;justify-content: space-between;margin: 10px 0px;">
                ...
                <div>
                    ...
                    <span>{{detailInfo?.device_info?.category }}</span>
                </div>
                <div>
            ...
            <p>
                <span style="color: gray;">租用开始时间：</span>
                <span>{{detailInfo?.status }}</span>
            </p>
            <p>
                <span style="color: gray;">租用结束时间：</span>
                <span>{{detailInfo?.status }}</span>
            </p>
        </a-card>
        <a-card class="detailBodyRight">
            <a-tabs v-model:activeKey="activeKey">
                <a-tab-pane key="1" tab="炒制数据">Content of Tab Pane 1</a-tab-pane>
                <a-tab-pane key="2" tab="设备履历">Content of Tab Pane 2</a-tab-pane>
                <a-tab-pane key="3" tab="故障统计">Content of Tab Pane 3</a-tab-pane>
                <a-tab-pane key="4" tab="设备详情">
                    <div class="detailInfo">
                        ...
                        <div>
                            <p>
                                <span style="color: gray;display: inline-block;width: 100px;">生产商名称：</span>
                                <span>{{detailInfo?.device_info?.operator_name }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 100px;">联系电话：</span>
                                <span>{{detailInfo?.device_info?.phone }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 100px;">生产商地址：</span>
                                <span>{{detailInfo?.device_info?.factory }}</span>
                            </p>
                            <a-divider style="margin:10px 0px;"/>
                        </div>
                        <div>
                            <p>
                                <span style="color: gray;display: inline-block;width: 100px;">代理商编号：</span>
                                <span>{{detailInfo?.channel?.code }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 100px;">代理商名称：</span>
                            ...
                            <p>
                                <span style="color: gray;display: inline-block;width: 100px;">联系地址：</span>
                                <span v-if="detailInfo?.channel">{{detailInfo?.channel?.channel_areas?.province}}{{detailInfo?.channel?.channel_areas?.city}}{{detailInfo?.channel?.channel_areas?.area}}</span>
                            </p>
                            <a-divider style="margin:10px 0px;"/>
                        </div>
                        <div>
                            <p>
                                <span style="color: gray;display: inline-block;width: 100px;">商户编号：</span>
                                <span>{{detailInfo?.device_info?.name }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 100px;">商户名称：</span>
                                <span>{{detailInfo?.device_info?.name }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 100px;">门店名称：</span>
                                <span>{{detailInfo?.device_info?.name }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 100px;">租用开始时间：</span>
                                <span>{{detailInfo?.device_info?.name }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 100px;">租用结束时间：</span>
                                <span>{{detailInfo?.device_info?.name }}</span>
                            </p>
                            <p>
                                <span style="color: gray;display: inline-block;width: 100px;">联系电话：</span>
...
export default defineComponent({
    ...
    setup(){
        ...
        const detailInfo=computed(() => ledgerStore.info ? ledgerStore.info :{});
        let activeKey=ref('1')
        console.log(ledgerStore.info,'kkk')
        return{
            activeKey,
            route,
            ledgerStore,
