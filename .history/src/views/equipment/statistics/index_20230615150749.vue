<template>
    <div class="ele-body">
        <a-card style="margin-top: 10px;border-radius: 4px;">
            <div id="proTable">
                <ele-pro-table ref="tableRef" title="设备统计" :resizable="true" :bordered="true" :columnsFixed="true" :needPage="false"
            ...
            <div style="text-align:right;margin-top: 10px;">
                <a-pagination size="small" :total="datasource.length" @change="changePage"
                    :show-total="listCount => `共 ${ datasource.length } 条`" />
            </div>
        </a-card>
    </div>
</template>
