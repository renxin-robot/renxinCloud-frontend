            ...
            <div id="proTable">
                <ele-pro-table ref="tableRef" title="设备统计" :resizable="true" :bordered="true" :columnsFixed="true"
                    ...
                    <template #bodyCell="{ column, record }">
                        <template v-if="column.key === 'mach_sts'">
                            <div>
                                <span v-if="record.iot_sts=='0'">离线</span>
                                <span v-if="record.iot_sts=='1'">在线</span>
                                <span v-if="record.iot_sts=='2'">故障</span>
                            </div>
                            <div>
                                <span v-if="record.mach_sts==0">待机</span>
                                <span v-if="record.mach_sts==1">运行</span>
                                <span v-if="record.mach_sts==2">故障</span>
                            </div>
                        </template>
                        <!-- 操作列 -->
