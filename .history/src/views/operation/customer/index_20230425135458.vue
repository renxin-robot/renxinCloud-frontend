...
export default defineComponent({
    ...
    setup() {
        ...
        const editCustomer = (row) => {
            ...
            areaInfo.areaList[0]=row.province_code
            areaInfo.areaList[1]=row.city_code
            areaInfo.areaList[2]=row.area_code
            areaInfo.areaList=(Object.values(areaList)).map((item)=>{
                return item
            })
            console.log( areaInfo.areaList,'hhh')
