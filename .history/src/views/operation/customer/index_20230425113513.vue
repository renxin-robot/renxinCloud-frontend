...
export default defineComponent({
    ...
    setup() {
        ...
        const editCustomer = (row) => {
            ...
            areaList.value.push(row.province_code)
            areaList.value.push(row.city_code)
            areaList.value.push(row.area_code)
            areaList.value=areaList.value.map((item)=>{
                return item
            })
            console.log(Object.getOwnPropertyDescriptor(areaList.value) ,'hhh')
