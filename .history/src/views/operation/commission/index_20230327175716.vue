        ...
        <a-modal v-model:visible="addVisible" :title="`${editId?'编辑':'新增'}渠道`" @ok="handleOk">
            <a-form :model="channelData" name="basic" :label-col="{ span: 5 }" :wrapper-col="{ span: 16 }" autocomplete="off">
                ...
                <a-form-item label="方案周期" name="type"
                    ...
                    <a-input v-model:value="channelData.type" />
                </a-form-item>
                <a-form-item label="饪芯（月）" name="renxin_amount"
                    :rules="[{ required: true, message: '请输入联系电话！' }]">
                    <a-input v-model:value="channelData.renxin_amount" />
                </a-form-item>
                <a-form-item label="代理商（月）" name="agent_amount"
                    :rules="[{ required: true, message: '请输入公司名称！' }]">
                    <a-input v-model:value="channelData.agent_amount" />
                </a-form-item>
                <a-form-item label="折扣" name="discount"
                    :rules="[{ required: true, message: '请输入企业税号！' }]">
                    <a-input v-model:value="channelData.discount" />
                </a-form-item>
                ...
                <a-form-item label="结算日期" name="settlement_day">
                    <a-input v-model:value="channelData.settlement_day" />
                </a-form-item>
